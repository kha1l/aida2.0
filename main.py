...
Config.scheduler.add_job(update_subs_day, 'cron', day_of_week='*', hour=3, minute=15)
Config.scheduler.add_job(update_tokens_app, 'cron', day_of_week="*", hour=3, minute=0)
...
Config.scheduler.add_job(stops_key_ings, 'interval', minutes=5, start_date=datetime(2023, 10, 11, 3, 10, 0))
Config.scheduler.add_job(stops_ings, 'interval', minutes=5, start_date=datetime(2023, 10, 11, 3, 12, 0))
Config.scheduler.add_job(stops_rest, 'interval', minutes=5, start_date=datetime(2023, 10, 11, 3, 13, 0))
Config.scheduler.add_job(stops_sector, 'interval', minutes=5, start_date=datetime(2023, 10, 11, 3, 14, 0))
Config.scheduler.add_job(send_tickets, 'interval', minutes=5, start_date=datetime(2023, 10, 11, 3, 15, 0))
Config.scheduler.add_job(application_stock, 'cron', day_of_week="*", hour=4, minute=0)
